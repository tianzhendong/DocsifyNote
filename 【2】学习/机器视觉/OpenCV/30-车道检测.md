...
![](https://gitee.com/tianzhendong/img/raw/master//images/202202240946430.jpeg)
...
![](https://gitee.com/tianzhendong/img/raw/master//images/202202240946812.jpeg)
...
![](https://gitee.com/tianzhendong/img/raw/master//images/cv2_lane_detection_roi_sample.jpg)
...
![](https://gitee.com/tianzhendong/img/raw/master//images/cv2_lane_detection_gray_blur_result.jpg)
...
![](https://gitee.com/tianzhendong/img/raw/master//images/cv2_lane_detection_canny_result.jpg)

### ROI截取

按照前面描述的方案，只需保留边缘图中的红线部分区域用于后续的霍夫直线检测，其余都是无用的信息：

![](https://gitee.com/tianzhendong/img/raw/master//images/202202241012327.jpeg)

如何实现呢？还记得图像混合中的这张图吗？

![](https://gitee.com/tianzhendong/img/raw/master//images/202202241012068.jpeg)

我们可以创建一个梯形的mask掩膜，然后与边缘检测结果图混合运算，掩膜中白色的部分保留，黑色的部分舍弃。梯形的四个坐标需要手动标记：

![](https://gitee.com/tianzhendong/img/raw/master//images/cv2_lane_detection_mask_sample.jpg)
...
注：`mask = np.zeros_like(img)`函数主要是想实现构造一个矩阵mask，其维度与矩阵img一致，并为其初始化为全0；这个函数方便的构造了新矩阵，无需参数指定shape大小；



这样，结果图"roi\_edges"应该是：

![](https://gitee.com/tianzhendong/img/raw/master//images/cv2_lane_detection_masked_roi_edges.jpg)
