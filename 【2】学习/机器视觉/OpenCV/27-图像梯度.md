...
还记得前面[平滑图像](【2】学习/机器视觉/OpenCV/17-平滑图像.md)中提到的滤波与模糊的区别吗？我们说**低通滤波器是模糊，高通滤波器是锐化**，这节我们就来看看高通滤波器。
...
> 还记得滤波函数`cv2.filter2D()`吗？（[番外篇: 卷积基础-图片边框](【2】学习/机器视觉/OpenCV/26-卷积基础-图片边框.md)）我们来手动实现上面的功能：
